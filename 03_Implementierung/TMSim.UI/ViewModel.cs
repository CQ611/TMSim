...
namespace TMSim.UI
{
    public partial class ViewModel : ObservableObject
    {
        ...
        private void RefreshTextFromUi()
        {
            ...
            PopupAddSymbolText = resourceManager.GetString("TEXT_PopupAddSymbol");
            PopupSymbolText = resourceManager.GetString("TEXT_PopupSymbol");
            PopupIsInputAlphabetText = resourceManager.GetString("TEXT_PopupIsInputAlphabet");
        }
